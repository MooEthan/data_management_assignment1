...
<head>
    ...
    <meta name="Zeeshan" content="Data Management">

    <title>Data Mangement- Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
             ...
             <!-- Nav Item - Charts -->
             <li class="nav-item">
                <a class="nav-link" href="showAllTables.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Show all Tables</span></a>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">November 7, 2024</div>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">November 2, 2024</div>
